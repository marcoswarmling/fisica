...
function convertTemp(direction){
    ...
    if (direction == "fire"){
        Cobj.value = Math.round((parseFloat(Fobj.value-32))*(5/9));
        Kobj.value = Math.round((parseFloat((Fobj.value - 32))*(5/9))+ 273);
    }
    else if (direction == "kelv"){
        Cobj.value = Math.round((parseFloat(Kobj.value - 273) ));
        Fobj.value = Math.round((parseFloat(Kobj.value - 273)*(9/5) + 32));
    }
     if (direction == "grau") {
